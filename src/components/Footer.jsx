        ...
        <ul className={styles.socialList}>
          <li className={styles.social}>
            <a href="https://www.linkedin.com/in/meredithgscott/" target="_blank" rel="noopener noreferrer">
              <img src="assets/linkedinIcon.png" className={styles.socialImage} alt="LinkedIn Icon"/>
            </a>
          </li>
          <li className={styles.social}>
            <a href="https://github.com/meredithscott131" target="_blank" rel="noopener noreferrer">
              <img src="assets/githubIcon.png"className={styles.socialImage} alt="GitHub Icon" />
            </a>
          </li>
          <li className={styles.social}>
            <a href="mailto:meredithscott131@gmail.com" target="_blank" rel="noopener noreferrer">
              <img src="assets/emailIcon.png" target="_blank" className={styles.socialImage} alt="Email Icon" />
            </a>
          </li>
        </ul>
      </div>
